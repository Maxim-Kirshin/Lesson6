package ru.mirea.kirshin.securedsharedpreference;
...
import ru.mirea.kirshin.securedsharedpreference.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.imageView3.setImageDrawable(getResources().getDrawable(R.drawable.mayakovsky,
                null));
